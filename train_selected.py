...
adjacency_matrix_sideways = pd.read_csv('correlation_matrix_sideways.csv', header=None).to_numpy()
adjacency_matrix_bear = pd.read_csv('correlation_matrix_bear.csv', header=None).to_numpy()
